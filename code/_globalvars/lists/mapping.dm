...
// the following are lookup tables! /// SOLARIS NOTE: subsystems don't have a lot of overhead compared to GLOB, right? We could probably make a dummy SSLookup subsystem for shit like this
