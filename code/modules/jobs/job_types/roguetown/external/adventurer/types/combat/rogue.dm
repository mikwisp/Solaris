...
/datum/outfit/job/roguetown/adventurer/rogue/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Treasure Hunter")
			...
			backpack_contents = list(/obj/item/lockpick = 1, /obj/item/rogueweapon/huntingknife = 1, /obj/item/roguekey/adventurers_guild = 1)
		...
		if("Bard")
			...
			backpack_contents = list(/obj/item/lockpick = 1, /obj/item/roguekey/adventurers_guild = 1)
		...
		if("Swashbuckler")
			...
			backpack_contents = list(/obj/item/bomb = 1, /obj/item/lockpick = 1, /obj/item/rogueweapon/huntingknife/idagger/steel/parrying = 1, /obj/item/roguekey/adventurers_guild = 1)
		...
		if("Buccaneer")
			...
			backpack_contents = list(/obj/item/powderhorn, /obj/item/gun/ballistic/arquebus_pistol, /obj/item/rogueweapon/huntingknife, /obj/item/roguekey/adventurers_guild = 1)
			H.cmode_music = 'sound/music/jukeboxes/oldschool/Sea_Shanty2.ogg'
			H.mind.adjust_skillrank(/datum/skill/combat/knives, 2, TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
			H.mind.adjust_skillrank(/datum/skill/misc/swimming, 4, TRUE)
