/datum/job/roguetown/bogguardsman
	...
	tutorial = "Typically a denizen of the sparsely populated Solar woods, you volunteered up with the wardens--a group of ranger types who keep a vigil over the untamed wilds."
