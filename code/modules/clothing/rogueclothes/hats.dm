...
/obj/item/clothing/head/roguetown/crown/serpcrown/proc/anti_stall()
	src.visible_message(span_warning("The Crown of Solaris crumbles to dust, the ashes spiriting away in the direction of the Keep."))
