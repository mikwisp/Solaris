...
/obj/item/paper/scroll/grudge
	...
	desc = "A copy you've taken with you. Unfortunately the dampness of Solaria made it unreadable. You can still add new entries, however. It looks bulky enough to act as a mild blunt weapon."
