...
/datum/mapGeneratorModule/beach
	...
	allowed_turfs = list(/turf/open/floor/rogue/dirt, /turf/open/floor/rogue/grass, /turf/open/floor/rogue/sand)
	...
	allowed_areas = list(/area/provincial/outdoors/beach/forest)
