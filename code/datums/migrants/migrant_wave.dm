...
/datum/migrant_wave/pilgrim
	...
	greet_text = "Fleeing from misfortune and hardship, you and a handful of survivors get closer to Solaris Ridge, looking for refuge and work, finally almost being there, almost..."
...
/datum/migrant_wave/adventurer
	...
	greet_text = "Together with a party of trusted friends we decided to venture out, seeking thrills, glory and treasure, ending up in the misty and damp bog within the southeast of Sunmarch, perhaps getting ourselves into more than what we bargained for."
