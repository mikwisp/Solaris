...
/datum/statpack/physical/muscular
	...
	stat_array = list(STAT_STRENGTH = 1, STAT_CONSTITUTION = 3, STAT_ENDURANCE = 1, STAT_SPEED = -2) //changed to be +2
...
/datum/statpack/physical/toil
	...
	stat_array = list(STAT_ENDURANCE = 2, STAT_CONSTITUTION = 2, STAT_PERCEPTION = -1, STAT_INTELLIGENCE = -1)
